...
To evaluate the models on unlearing benchmarks, follow their instructions and use the checkpoints or generated images from the experiments here. See [CSD](https://github.com/learn2phoenix/CSD#), [Artist Erasure Eval (CP)](baselines/concept_prune/eval_artish.sh), and [NSFW removal Eval](baselines/concept_prune/eval_nudity.sh).
