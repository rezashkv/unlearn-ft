...
def main():
    ...
    args.benchmarking_result_path = os.path.join(args.benchmarking_result_path, args.model_id, args.target,args.baseline, 'benchmarking', 'concept_erase', run_ckpt)
    ...
    if len(os.listdir(f'{args.benchmarking_result_path}/concept_erase')) == 0:
        ...
        # model = StableDiffusionPipeline.from_pretrained(args.model_id)
