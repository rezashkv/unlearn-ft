...
uce_models_dict = {
    'Van Gogh': '/path/to/unified-concept-editing/train-scripts/models/erased-van goh_claude monet_picasso-towards_art-preserve_true-sd_2_1-method_replace.pt',
    'Monet': '/path/to/unified-concept-editing/train-scripts/models/erased-van goh_claude monet_picasso-towards_art-preserve_true-sd_2_1-method_replace.pt',
    'Pablo Picasso': '/path/to/unified-concept-editing/train-scripts/models/erased-van goh_claude monet_picasso-towards_art-preserve_true-sd_2_1-method_replace.pt',
...
esd_models_dict = {
    'Van Gogh': '/path/to/erasing/models/esd-vangogh_from_vangogh-xattn_1-epochs_1000.pt',
    'Monet': '/path/to/erasing/models/esd-clausemonet_from_clausemonet-xattn_1-epochs_1000.pt',
    'Pablo Picasso': '/path/to/erasing/models/esd-picasso_from_picasso-xattn_1-epochs_1000.pt',
