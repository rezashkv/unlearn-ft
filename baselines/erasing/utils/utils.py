...
class StableDiffuser(torch.nn.Module):
    ...
    def __init__(self,
        ...
        arch_v = torch.load(os.path.join(ckpt_path, "arch_vector.pt"), map_location="cpu")
        ...
        state_dict = safetensors.torch.load_file(os.path.join(ckpt_path, "unet",
        ...
        self.feature_extractor = CLIPFeatureExtractor.from_pretrained("stabilityai/stable-diffusion-2-1", subfolder="feature_extractor")
