...
if __name__ == '__main__':
    # save_coco_captions('/path/to/coco/annotations/captions_val2014_30k.json')
    # save_cc3m_captions('/path/to/cc3m')
    save_coco_captions("/path/to/coco/annotations/captions_val2017.json")
